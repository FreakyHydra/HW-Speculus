...
import { exportV2Session, importV2Session, loadV2Session, saveV2Session, V2_STORAGE_KEY } from '../src/v2/storage/session';
...
describe('V2 session boundary', () => {
  ...
  it('exports no launch authorization and preserves fresh authorization on import', () => {
    const old = fresh(); old.draft = 'Preserve this draft';
    const raw = exportV2Session(old);
